...
class upem extends StatefulWidget {
  const upem({Key? key}) : super(key: key);

  @override
  _upemState createState() => _upemState();
}
class _upemState extends State<upem> {
                                  ...
                                  if (_keyForm.currentState!.validate()) {
                                    us.updateEmail(_mail.text);
                                      ...
                                      ScaffoldMessenger.of(context).showSnackBar(
                                          const SnackBar(
                                              content: Text('Login with your new email!'),
